...
class Fun(commands.Cog):
    ...
    @app_commands.command(name="jugar", description="Juega a Fuego, Nieve y Agua")
    async def jugar(self, interaction: discord.Interaction, opcion: str):
        try:
            ...
            resultado = self.determinar_ganador(opcion.lower(), bot_choice)
    ...
    @app_commands.command(name="trivia", description="Pregunta de trivia aleatoria con opciones múltiples")
    ...
    def determinar_ganador(self, jugador, bot):
        if jugador == bot:
